...
`yuyou-dev/GrillMeJewel` at release `v0.3.0`, verify its Skill and local Apps UI MCP, then ask the
...
```text
"<CODEX_BIN>" plugin marketplace add yuyou-dev/GrillMeJewel --ref v0.3.0 --json
```
